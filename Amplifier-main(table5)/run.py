...
if __name__ == '__main__':
    ...
    # FLinear
    parser.add_argument('--flinear_alpha', type=float, default=0.9, help='FLinear alpha')
    parser.add_argument('--flinear_c', type=float, default=1.0, help='FLinear c')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            exp = Exp(args)
            setting = '{}_{}_{}_sl{}_pl{}_hidden{}_SCI{}_epochs{}_bc{}_lr{}_flinear_c{}_flinear_alpha{}_{}'.format(
                args.model_id,
                args.model,
                args.data,
                args.seq_len,
