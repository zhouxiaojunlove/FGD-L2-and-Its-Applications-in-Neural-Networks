...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.flinear_alpha = configs.flinear_alpha
        self.flinear_c = configs.flinear_c
        ...
        self.linear_seasonal = nn.Sequential(
            ...
            FLinear(self.seq_len, self.hidden_size, self.flinear_alpha, self.flinear_c),
            nn.LeakyReLU(),
            # nn.Linear(self.hidden_size, self.pred_len)
            FLinear(self.hidden_size, self.pred_len, self.flinear_alpha, self.flinear_c)
        )
        ...
        self.extract_common_pattern = nn.Sequential(
            ...
            FLinear(self.channels, self.channels, self.flinear_alpha, self.flinear_c),
            nn.LeakyReLU(),
            # nn.Linear(self.channels, 1)
            FLinear(self.channels, 1, self.flinear_alpha, self.flinear_c)
        )
        ...
        self.model_common_pattern = nn.Sequential(
            ...
            FLinear(self.hidden_size, self.seq_len, self.flinear_alpha, self.flinear_c)
        )
